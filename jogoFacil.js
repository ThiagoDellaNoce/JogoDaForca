function iniciaJogo()
{
	...
	var numeroRandom = Math.floor((Math.random() * vetorFacil.length));
	palavraSelecionada.text(vetorFacil[numeroRandom]);
	dicaSelecionada.text(vetorDicaFacil[numeroRandom]);
