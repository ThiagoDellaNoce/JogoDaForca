function iniciaJogo()
{
	...
	var numeroRandom = Math.floor((Math.random() * vetorDificil.length));
	palavraSelecionada.text(vetorDificil[numeroRandom]);
	dicaSelecionada.text(vetorDicaDificil[numeroRandom]);
